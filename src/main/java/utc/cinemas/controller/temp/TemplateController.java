...
public class TemplateController {
    ...
    public String createEquipment(Model model) {
        return renderPage(model, "equipments", "contents/equipments/form", "Thêm thiết bị - UTC Cinemas");
    }
    ...
    public String editEquipment(@RequestParam String id, Model model) {
        model.addAttribute("id", id);
        return renderPage(model, "equipments", "contents/equipments/form", "Sửa thiết bị - UTC Cinemas");
    }
    ...
    public String createProduct(Model model) {
        return renderPage(model, "products", "contents/products/form", "Thêm sản phẩm - UTC Cinemas");
    }
    ...
    public String editProduct(@RequestParam String id, Model model) {
        model.addAttribute("id", id);
        return renderPage(model, "products", "contents/products/form", "Sửa sản phẩm - UTC Cinemas");
    }
